...
export interface BackOfficeEvent {
  ...
  status: Health;
  latencyMs?: number;
  direction?: 'loco-to-system' | 'system-to-loco' | 'system-to-system'; // message direction
  empMessageNumber?: string;  // EMP message number e.g. '02050', '101', '02060'
  empMessageLabel?: string;   // Human-readable label e.g. 'Authority Request'
  from?: string;              // Originating system/entity
  to?: string;                // Destination system/entity
}
...
export const TRAINS: TrainRecord[] = [
  // ── Train 1: CN 3864 / Bala Sub ──────────────────────────────────────────
  {
    ...
    backOfficeEvents: [
      { time: "13:44:00", system: "KES",    event: "BL-OPK issued to CN 2743 — valid 24h, expires 13:44 tomorrow", status: "healthy", latencyMs: 120,  direction: 'system-to-loco',   empMessageNumber: '101', empMessageLabel: 'BL-OPK Issue',          from: 'KES',    to: 'CN 2743 (I-ETMS)' },
      { time: "13:44:01", system: "KES",    event: "W-OPK distributed to WIU MP 44.5 — config file re-encrypted", status: "healthy", latencyMs: 95,   direction: 'system-to-system', empMessageNumber: '103', empMessageLabel: 'W-OPK Distribute',       from: 'KES',    to: 'WIU MP 44.5' },
      { time: "13:44:02", system: "I-ETMS", event: "BL-OPK acknowledged — EMP 102 response sent to KES", status: "healthy", latencyMs: 48,   direction: 'loco-to-system',   empMessageNumber: '102', empMessageLabel: 'BL-OPK Acknowledge',    from: 'CN 2743 (I-ETMS)', to: 'KES' },
      { time: "13:45:12", system: "CI BOS", event: "Crew Authentication request received — Engineer ID 4821", status: "healthy", latencyMs: 0,    direction: 'loco-to-system',   empMessageNumber: '02000', empMessageLabel: 'Crew Auth Request',    from: 'CN 2743 (I-ETMS)', to: 'CI BOS' },
      { time: "13:45:12", system: "CI BOS", event: "Crew identity verified · Engineer ID 4821 confirmed", status: "healthy", latencyMs: 340,  direction: 'system-to-loco',   empMessageNumber: '02010', empMessageLabel: 'Crew Auth Response',   from: 'CI BOS', to: 'CN 2743 (I-ETMS)' },
      { time: "13:46:30", system: "I-ETMS", event: "Consist Registration sent — 8 units, lead CN 2743", status: "healthy", latencyMs: 0,    direction: 'loco-to-system',   empMessageNumber: '02030', empMessageLabel: 'Consist Registration', from: 'CN 2743 (I-ETMS)', to: 'G BOS' },
      { time: "13:46:30", system: "G BOS",  event: "Consist data delivered · 8 units · Subdivision list updated", status: "healthy", latencyMs: 890,  direction: 'system-to-loco',   empMessageNumber: '02040', empMessageLabel: 'Consist Response',     from: 'G BOS', to: 'CN 2743 (I-ETMS)' },
      { time: "13:47:01", system: "I-ETMS", event: "Movement Authority Request sent — Bala Sub MP 0.0 → MP 62.4", status: "healthy", latencyMs: 0,    direction: 'loco-to-system',   empMessageNumber: '02050', empMessageLabel: 'Authority Request',    from: 'CN 2743 (I-ETMS)', to: 'PDS' },
      { time: "13:47:01", system: "PDS",    event: "Movement authority issued · Bala Sub MP 0.0 → MP 62.4", status: "healthy", latencyMs: 210,  direction: 'system-to-loco',   empMessageNumber: '02060', empMessageLabel: 'Authority Response (MA)', from: 'PDS', to: 'CN 2743 (I-ETMS)' },
      { time: "13:47:45", system: "ITCM",   event: "Authority delivered to I-ETMS onboard via AMQP · 42s delivery", status: "healthy", latencyMs: 42000, direction: 'system-to-loco',  empMessageNumber: '02060', empMessageLabel: 'MA Delivery (AMQP)',   from: 'ITCM', to: 'CN 2743 (I-ETMS)' },
      { time: "13:52:00", system: "I-ETMS", event: "Polling keep-alive sent — EMP 02100", status: "healthy", latencyMs: 0,    direction: 'loco-to-system',   empMessageNumber: '02100', empMessageLabel: 'Polling',              from: 'CN 2743 (I-ETMS)', to: 'BOS' },
      { time: "13:52:00", system: "BOS",    event: "Polling response acknowledged — EMP 02110", status: "healthy", latencyMs: 380,  direction: 'system-to-loco',   empMessageNumber: '02110', empMessageLabel: 'Polling Response',     from: 'BOS', to: 'CN 2743 (I-ETMS)' },
      { time: "14:11:46", system: "CARMA",  event: "HBD MP 18.7 — Car CN 8831 Axle A3-R: 184°F · ABD elevated · Monitoring flag set", status: "warning", direction: 'system-to-system', empMessageNumber: '06200', empMessageLabel: 'WASP Alert',           from: 'CARMA', to: 'Dispatcher / OWL' },
      { time: "14:22:00", system: "I-ETMS", event: "Authority Renewal Request — approaching MA boundary MP 62.4", status: "healthy", latencyMs: 0,    direction: 'loco-to-system',   empMessageNumber: '02070', empMessageLabel: 'Authority Renewal Req', from: 'CN 2743 (I-ETMS)', to: 'PDS' },
      { time: "14:22:00", system: "PDS",    event: "Authority Renewal granted — extended to MP 88.0", status: "healthy", latencyMs: 190,  direction: 'system-to-loco',   empMessageNumber: '02080', empMessageLabel: 'Authority Renewal Resp', from: 'PDS', to: 'CN 2743 (I-ETMS)' },
      { time: "14:24:37", system: "CARMA",  event: "Crossing MP 27.6 gate delay alert raised · Priority 3", status: "warning", direction: 'system-to-system', empMessageNumber: '06200', empMessageLabel: 'WASP Alert',           from: 'CARMA', to: 'Dispatcher / OWL' },
      { time: "14:51:42", system: "BOS",    event: "HMAC validation failure at WIU MP 44.5 · OPK mismatch", status: "critical", latencyMs: 12400, direction: 'system-to-system', empMessageNumber: '103', empMessageLabel: 'OPK Validation Fail',  from: 'BOS', to: 'KES' },
      { time: "14:51:44", system: "KES",    event: "Emergency re-key initiated for WIU MP 44.5", status: "warning", latencyMs: 800,  direction: 'system-to-system', empMessageNumber: '103', empMessageLabel: 'W-OPK Emergency Rekey', from: 'KES', to: 'WIU MP 44.5' },
      { time: "14:52:31", system: "BOS",    event: "New OPK distributed and validated · WIU MP 44.5 restored", status: "healthy", latencyMs: 340,  direction: 'system-to-system', empMessageNumber: '103', empMessageLabel: 'W-OPK Restored',       from: 'KES', to: 'WIU MP 44.5 / BOS' },
    ],
  },
  ...
  // ── Train 2: CN 5501 / Ruel Sub ──────────────────────────────────────────
  {
    ...
    backOfficeEvents: [
      { time: "11:20:00", system: "KES",    event: "BL-OPK issued to CN 3301 — valid 24h", status: "healthy", latencyMs: 130, direction: 'system-to-loco',   empMessageNumber: '101',   empMessageLabel: 'BL-OPK Issue',          from: 'KES',    to: 'CN 3301 (I-ETMS)' },
      { time: "11:20:01", system: "KES",    event: "W-OPK distributed to all Ruel Sub WIUs", status: "healthy", latencyMs: 95,  direction: 'system-to-system', empMessageNumber: '103',   empMessageLabel: 'W-OPK Distribute',       from: 'KES',    to: 'Ruel Sub WIUs' },
      { time: "11:21:10", system: "I-ETMS", event: "Crew Authentication request — Engineer ID 5512", status: "healthy", latencyMs: 0,   direction: 'loco-to-system',   empMessageNumber: '02000', empMessageLabel: 'Crew Auth Request',    from: 'CN 3301 (I-ETMS)', to: 'CI BOS' },
      { time: "11:21:10", system: "CI BOS", event: "Crew identity verified · Engineer ID 5512 confirmed", status: "healthy", latencyMs: 290, direction: 'system-to-loco',   empMessageNumber: '02010', empMessageLabel: 'Crew Auth Response',   from: 'CI BOS', to: 'CN 3301 (I-ETMS)' },
      { time: "11:22:05", system: "I-ETMS", event: "Consist Registration — 7 units, lead CN 3301", status: "healthy", latencyMs: 0,   direction: 'loco-to-system',   empMessageNumber: '02030', empMessageLabel: 'Consist Registration', from: 'CN 3301 (I-ETMS)', to: 'G BOS' },
      { time: "11:22:05", system: "G BOS",  event: "Consist data delivered · 7 units · Subdivision list updated", status: "healthy", latencyMs: 760, direction: 'system-to-loco',   empMessageNumber: '02040', empMessageLabel: 'Consist Response',     from: 'G BOS', to: 'CN 3301 (I-ETMS)' },
      { time: "11:22:44", system: "I-ETMS", event: "Movement Authority Request — Ruel Sub MP 0.0 → MP 102.6", status: "healthy", latencyMs: 0,   direction: 'loco-to-system',   empMessageNumber: '02050', empMessageLabel: 'Authority Request',    from: 'CN 3301 (I-ETMS)', to: 'PDS' },
      { time: "11:22:44", system: "PDS",    event: "Movement authority issued · Ruel Sub MP 0.0 → MP 102.6", status: "healthy", latencyMs: 190, direction: 'system-to-loco',   empMessageNumber: '02060', empMessageLabel: 'Authority Response (MA)', from: 'PDS', to: 'CN 3301 (I-ETMS)' },
  ...
  // ── Train 3: CN 4102 / Kingston Sub ──────────────────────────────────────
  {
    ...
    backOfficeEvents: [
      { time: "09:05:00", system: "KES",    event: "BL-OPK issued to CN 2201 — valid 24h", status: "healthy", latencyMs: 115, direction: 'system-to-loco',   empMessageNumber: '101',   empMessageLabel: 'BL-OPK Issue',          from: 'KES',    to: 'CN 2201 (I-ETMS)' },
      { time: "09:05:01", system: "KES",    event: "W-OPK distributed to all Kingston Sub WIUs", status: "healthy", latencyMs: 88,  direction: 'system-to-system', empMessageNumber: '103',   empMessageLabel: 'W-OPK Distribute',       from: 'KES',    to: 'Kingston Sub WIUs' },
      { time: "09:06:10", system: "I-ETMS", event: "Crew Authentication request — Engineer ID 3301", status: "healthy", latencyMs: 0,   direction: 'loco-to-system',   empMessageNumber: '02000', empMessageLabel: 'Crew Auth Request',    from: 'CN 2201 (I-ETMS)', to: 'CI BOS' },
      { time: "09:06:10", system: "CI BOS", event: "Crew identity verified · Engineer ID 3301 confirmed", status: "healthy", latencyMs: 310, direction: 'system-to-loco',   empMessageNumber: '02010', empMessageLabel: 'Crew Auth Response',   from: 'CI BOS', to: 'CN 2201 (I-ETMS)' },
      { time: "09:07:05", system: "I-ETMS", event: "Consist Registration — 6 units, lead CN 2201", status: "healthy", latencyMs: 0,   direction: 'loco-to-system',   empMessageNumber: '02030', empMessageLabel: 'Consist Registration', from: 'CN 2201 (I-ETMS)', to: 'G BOS' },
      { time: "09:07:05", system: "G BOS",  event: "Consist data delivered · 6 units · Subdivision list updated", status: "healthy", latencyMs: 820, direction: 'system-to-loco',   empMessageNumber: '02040', empMessageLabel: 'Consist Response',     from: 'G BOS', to: 'CN 2201 (I-ETMS)' },
      { time: "09:07:44", system: "I-ETMS", event: "Movement Authority Request — Kingston Sub MP 0.0 → MP 180.0", status: "healthy", latencyMs: 0,   direction: 'loco-to-system',   empMessageNumber: '02050', empMessageLabel: 'Authority Request',    from: 'CN 2201 (I-ETMS)', to: 'PDS' },
      { time: "09:07:44", system: "PDS",    event: "Movement authority issued · Kingston Sub MP 0.0 → MP 180.0", status: "healthy", latencyMs: 200, direction: 'system-to-loco',   empMessageNumber: '02060', empMessageLabel: 'Authority Response (MA)', from: 'PDS', to: 'CN 2201 (I-ETMS)' },
      { time: "09:08:10", system: "ITCM",   event: "Authority delivered to I-ETMS onboard via AMQP · 38s delivery", status: "healthy", latencyMs: 38000, direction: 'system-to-loco', empMessageNumber: '02060', empMessageLabel: 'MA Delivery (AMQP)',   from: 'ITCM', to: 'CN 2201 (I-ETMS)' },
      { time: "09:15:00", system: "I-ETMS", event: "Polling keep-alive — EMP 02100", status: "healthy", latencyMs: 0,   direction: 'loco-to-system',   empMessageNumber: '02100', empMessageLabel: 'Polling',              from: 'CN 2201 (I-ETMS)', to: 'BOS' },
      { time: "09:15:00", system: "BOS",    event: "Polling response acknowledged — EMP 02110", status: "healthy", latencyMs: 310, direction: 'system-to-loco',   empMessageNumber: '02110', empMessageLabel: 'Polling Response',     from: 'BOS', to: 'CN 2201 (I-ETMS)' },
      { time: "12:09:13", system: "CARMA",  event: "DED MP 128.3 — CN 9903/9904 dragging equipment · Crew notified · Priority 2", status: "warning", direction: 'system-to-system', empMessageNumber: '06200', empMessageLabel: 'WASP Alert',           from: 'CARMA', to: 'Dispatcher / OWL' },
      { time: "12:09:15", system: "ServiceNow", event: "INC-20250504-044 created · DED contact · Priority 2 · Inspection at Kingston Yard", status: "warning", direction: 'system-to-system', empMessageNumber: 'ITSM', empMessageLabel: 'Incident Created',     from: 'CARMA', to: 'ServiceNow' },
    ],
  },
  ...
  // ── Train 4: CN 7788 / Capreol Sub ───────────────────────────────────────
  {
    ...
    backOfficeEvents: [
      { time: "07:30:00", system: "KES",    event: "BL-OPK issued to CN 4401 — valid 24h", status: "healthy", latencyMs: 125, direction: 'system-to-loco',   empMessageNumber: '101',   empMessageLabel: 'BL-OPK Issue',          from: 'KES',    to: 'CN 4401 (I-ETMS)' },
      { time: "07:30:01", system: "KES",    event: "W-OPK distributed to all Capreol Sub WIUs", status: "healthy", latencyMs: 92,  direction: 'system-to-system', empMessageNumber: '103',   empMessageLabel: 'W-OPK Distribute',       from: 'KES',    to: 'Capreol Sub WIUs' },
      { time: "07:31:10", system: "I-ETMS", event: "Crew Authentication request — Engineer ID 7712", status: "healthy", latencyMs: 0,   direction: 'loco-to-system',   empMessageNumber: '02000', empMessageLabel: 'Crew Auth Request',    from: 'CN 4401 (I-ETMS)', to: 'CI BOS' },
      { time: "07:31:10", system: "CI BOS", event: "Crew identity verified · Engineer ID 7712 confirmed", status: "healthy", latencyMs: 320, direction: 'system-to-loco',   empMessageNumber: '02010', empMessageLabel: 'Crew Auth Response',   from: 'CI BOS', to: 'CN 4401 (I-ETMS)' },
      { time: "07:32:05", system: "I-ETMS", event: "Consist Registration — 9 units, lead CN 4401", status: "healthy", latencyMs: 0,   direction: 'loco-to-system',   empMessageNumber: '02030', empMessageLabel: 'Consist Registration', from: 'CN 4401 (I-ETMS)', to: 'G BOS' },
      { time: "07:32:05", system: "G BOS",  event: "Consist data delivered · 9 units · Subdivision list updated", status: "healthy", latencyMs: 910, direction: 'system-to-loco',   empMessageNumber: '02040', empMessageLabel: 'Consist Response',     from: 'G BOS', to: 'CN 4401 (I-ETMS)' },
      { time: "07:32:44", system: "I-ETMS", event: "Movement Authority Request — Capreol Sub MP 0.0 → MP 220.0", status: "healthy", latencyMs: 0,   direction: 'loco-to-system',   empMessageNumber: '02050', empMessageLabel: 'Authority Request',    from: 'CN 4401 (I-ETMS)', to: 'PDS' },
      { time: "07:32:44", system: "PDS",    event: "Movement authority issued · Capreol Sub MP 0.0 → MP 220.0", status: "healthy", latencyMs: 210, direction: 'system-to-loco',   empMessageNumber: '02060', empMessageLabel: 'Authority Response (MA)', from: 'PDS', to: 'CN 4401 (I-ETMS)' },
      { time: "07:40:00", system: "I-ETMS", event: "Polling keep-alive — EMP 02100", status: "healthy", latencyMs: 0,   direction: 'loco-to-system',   empMessageNumber: '02100', empMessageLabel: 'Polling',              from: 'CN 4401 (I-ETMS)', to: 'BOS' },
      { time: "07:40:00", system: "BOS",    event: "Polling response acknowledged — EMP 02110", status: "healthy", latencyMs: 295, direction: 'system-to-loco',   empMessageNumber: '02110', empMessageLabel: 'Polling Response',     from: 'BOS', to: 'CN 4401 (I-ETMS)' },
      { time: "08:28:16", system: "CARMA",  event: "TPD MP 44.2 — CN 6603 truck instability score 72 · Monitoring flag set", status: "warning", direction: 'system-to-system', empMessageNumber: '06200', empMessageLabel: 'WASP Alert',           from: 'CARMA', to: 'Dispatcher / OWL' },
      { time: "12:01:15", system: "PDS",    event: "Authority update delayed — dispatcher queue congested", status: "warning", latencyMs: 0, direction: 'system-to-loco',   empMessageNumber: '02060', empMessageLabel: 'MA Delay Warning',     from: 'PDS', to: 'CN 4401 (I-ETMS)' },
      { time: "12:01:20", system: "CDU",    event: "Authority expiry warning displayed to crew at MP 212.4", status: "warning", direction: 'system-to-loco',   empMessageNumber: 'CDU',   empMessageLabel: 'CDU Display Alert',    from: 'I-ETMS (CDU)', to: 'Crew' },
      { time: "12:01:22", system: "ServiceNow", event: "INC-20250504-031 created · Priority 3 · Train held at MP 212.4", status: "warning", direction: 'system-to-system', empMessageNumber: 'ITSM', empMessageLabel: 'Incident Created',     from: 'PDS', to: 'ServiceNow' },
    ],
  },
];
